...
- **B** NOTE-3 read-path scoping (own cross-repo PR + Rajesh QA). DISCOVERY DONE 2026-07-08T17:1x:
  ...
  - **Phase-1 carry-forward flags:** (1) scoping drops headline 'live metrics' (620K+ businesses → ~370K in-scope) — product/marketing sign-off Matt owns, surfaced to him; (2) Explorer v1 live pages untouched until Phase-1.
