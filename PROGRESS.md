...
- **CONTRACT AUTHORED 03:18Z (item-5, forward pre-work while holding):** konnex-data-pipeline/ITEM5-WEBSITE-REVERIFICATION-CONTRACT-v1.md on branch wip/jack-item5-recrawl-contract-20260711 (pushed, off origin/main). Scope 175,982; canary-first; code-grounded on v2-verification-worker.js (V2V_CYCLE_COST_CAP_AUD, V2V_CONCURRENCY, urlNormalisedEqual flip); 6 ACs; reversible. Handed to Rajesh (QA, sig 033e716422ed47be) + Grace aligned (7e9fc8e775a11d20). Still Matt-gated — DRAFT until Matt confirms scope + canary spend GO. Did NOT re-ping Matt (avoid noise pre-reply); point him to the file if he asks.
